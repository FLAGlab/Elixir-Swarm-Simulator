defmodule SimulatorWeb.SimulationController do
  ...
  def index(conn, _params) do
    ...
    render(conn, :index, simulations: simulations, changeset: changeset, algorithms: get_algorithms())
  end

  def new(conn, _params) do
    changeset = Simulations.change_simulation(%Simulation{})
    render(conn, :new, changeset: changeset, algorithms: get_algorithms())
  end
  ...
  def show(conn, %{"id" => id}) do
    ...
    render(conn, :show, simulation: simulation, algorithms: get_algorithms())
  end

  def edit(conn, %{"id" => id}) do
    simulation = Simulations.get_simulation!(id)
    changeset = Simulations.change_simulation(simulation)
    render(conn, :edit, simulation: simulation, changeset: changeset, algorithms: get_algorithms())
  end
